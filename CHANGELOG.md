...
##  [0.4.3] - 2024-10-11
### Cambios
- Completando cobertura en test board y test chess
- Solucionando issues en pawn

##  [0.4.2] - 2024-10-10
### Cambios
- Refactorizando codigo en las piezas king, pawn, queen y rook
- Refactorizando metodo mover_pieza y is_valid_move
...
- Cambiando logica para solicitar empate
- Implementando test para cli.
